...
function App() {
  ...
  // Fecha objetivo: 8 de agosto a las 00:00
...
<div className="flowers-divider">
  ...
  <div className="container">
    <div className="box">
      <h2 className="countertext">{timeLeft.days}</h2>
    </div>
    <div className="box">
      <h2 className="countertext">{timeLeft.hours}</h2>
   
   </div>
   
   <div className="box">
      <h2 className="countertext">{timeLeft.minutes}</h2>
    </div>
...
<div className="flowers-divider3">
  ...
  <img src={flower4} className="flower-right3" />
       ...
       <section className="section4">
        ...
        <h3 className="vestsubtitle">Codigo de vestimenta</h3>
